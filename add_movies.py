...
# Thiết lập Django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'cinema_ticket_booking.settings')
django.setup()
...
for movie_data in MOVIES_DATA:
    try:
        ...
        movie.save()
        print(f"Đã thêm phim: {movie_data['title']}")
    except Exception as e:
        print(f"Lỗi khi thêm phim {movie_data['title']}: {str(e)}")

print("Hoàn tất việc thêm phim!") 